 ...
 * @author HP-Pavilion
 */
public class v_VerTarjeta extends javax.swing.JFrame {

    /**
     * Creates new form v_VerTarjeta
     */
    public v_VerTarjeta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Pantalla Principal (P - 6)");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        v_ObtenerRegistro obtener = new v_ObtenerRegistro();
        obtener.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_VerTarjeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_VerTarjeta().setVisible(true);
            }
        });
    }
